...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <h1 class="sr-only">Paramètres de l'authentification à deux facteurs</h1>
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        un code sécurisé vous sera demandé à la connexion. Vous
                        pouvez récupérer ce code depuis une application prenant
                        en charge le TOTP sur votre téléphone.
                    </p>
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        sécurisé vous sera demandé à la connexion. Vous pouvez
                        le récupérer depuis une application compatible TOTP sur
                        votre téléphone.
                    </p>
