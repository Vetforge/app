    ...
    @php
        ...
        $sections2018Page2 = [
            $section('Acides aminés digestibles', 'Profil DI', $fieldRows([
                ['lys_di', 'LysDI', 'g/kg MS', 2],
                ['met_di', 'MetDI', 'g/kg MS', 2],
                ['his_di', 'HisDI', 'g/kg MS', 2],
                ['arg_di', 'ArgDI', 'g/kg MS', 2],
                ['thr_di', 'ThrDI', 'g/kg MS', 2],
                ['val_di', 'ValDI', 'g/kg MS', 2],
                ['ile_di', 'IleDI', 'g/kg MS', 2],
                ['leu_di', 'LeuDI', 'g/kg MS', 2],
                ['phe_di', 'PheDI', 'g/kg MS', 2],
                ['asp_di', 'AspDI', 'g/kg MS', 2],
                ['ser_di', 'SerDI', 'g/kg MS', 2],
                ['glu_di', 'GluDI', 'g/kg MS', 2],
                ['pro_di', 'ProDI', 'g/kg MS', 2],
                ['gly_di', 'GlyDI', 'g/kg MS', 2],
                ['ala_di', 'AlaDI', 'g/kg MS', 2],
                ['tyr_di', 'TyrDI', 'g/kg MS', 2],
            ])),
