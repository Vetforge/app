...
{
    /**
     * Modifier les valeurs alimentaires d'un ensilage d'herbe Prairie Permanente première coupe sans conservateur en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        $EBo2 = ($EBo1);
        // DT_N=73,7+0,088MAT-0,00011MAT*MAT-0,25MS+2,5
        ...
        $MOF25 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 140 / 1000 * $MS);
        // MS=30 MOF=MOD-MG-(MAT*(1-DT/100))-(140/1000*MS)
        $MOF30 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 140 / 1000 * $MS);
        // MS=35 MOF=MOD-MG-(MAT*(1-DT/100))-(140/1000*MS)
        $MOF35 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 140 / 1000 * $MS);
        // MS=40 MOF=MOD-MG-(MAT*(1-DT/100))-(140/1000*MS)
        $MOF40 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 140 / 1000 * $MS);
