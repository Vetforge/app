...
{
    /**
     * Modifier les valeurs alimentaires d'un ensilage d'herbe Graminées deuxième coupe avec conservateur en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // dMO%=123,6-0,169*ADF(g/kgMS)
        $dMO = (123.6 - (0.169 * $adfgKgMS));
        // dE%=1,0263dMO-5,723
        $dE = ((1.0263 * $dMO) - 5.723);
        // EBo=1,03*(4531+1,735*MATo-71)
        ...
        // MOD=MO*dMO/100
        $MOD = ($MOgKgMB * $dMO / 100);
        // MS=25 MOF=MOD-MG-(MAT*(1-DT/100))-(95/1000*MS)
        $MOF25 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 95 / 1000 * $MS);
        // MS=30 MOF=MOD-MG-(MAT*(1-DT/100))-(95/1000*MS)
        $MOF30 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 95 / 1000 * $MS);
        // MS=35 MOF=MOD-MG-(MAT*(1-DT/100))-(95/1000*MS)
        $MOF35 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 95 / 1000 * $MS);
        // MS=40 MOF=MOD-MG-(MAT*(1-DT/100))-(95/1000*MS)
        $MOF40 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 95 / 1000 * $MS);
