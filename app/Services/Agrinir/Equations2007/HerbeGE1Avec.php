...
{
    /**
     * Modifier les valeurs alimentaires d'un ensilage d'herbe Graminées première coupe avec conservateur en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        $EBo2 = ($EBo1);
        // DT_N=0,96*(73,7+0,088MAT-0,00011MAT*MAT-0,25MS+4,9)
        $DT_N = ((73.7 + (0.088 * $MATgKgMS) - (0.00011 * $MATgKgMS * $MATgKgMS) - (0.25 * $MS100) + 4.9) * 0.96);
