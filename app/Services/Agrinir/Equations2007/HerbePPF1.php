...
{
    /**
     * Modifier les valeurs alimentaires d'un foin d'herbe Prairie Permanente première coupe en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // EBo=4531+1,735*MATo+82
        $EBo2 = ($EBo1);
        // DT_N=50,8+0,12*MAT-0,00018MAT*MAT+1,9
