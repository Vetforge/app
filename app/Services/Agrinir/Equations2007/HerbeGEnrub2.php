...
{
    /**
     * Modifier les valeurs alimentaires d'un emrubanné d'herbe Graminées deuxième coupe en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // MS>50 DT%=50,8+0,12*MAT-0,00018MAT*MAT+3,2
        if ($MS100 >= 50) {
