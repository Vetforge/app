...
class HerbePPEnrub2
{
    ...
    public static function modifierValeursAlimentaires(
        ...
        $EBo2 = ($EBo1);
        // MS<50 DT%=73,7+0,088MAT-0,00011MAT*MAT-0,25MS
        if ($MS100 < 50) {
            $DT_N = (73.7 + (0.088 * $MATgKgMS) - (0.00011 * $MATgKgMS * $MATgKgMS) - (0.25 * $MS100));
        }
        // MS>50 DT%=50,8+0,12*MAT-0,00018MAT*MAT
        if ($MS100 >= 50) {
            $DT_N = (50.8 + (0.12 * $MATgKgMS) - (0.00018 * $MATgKgMS * $MATgKgMS));
        }
