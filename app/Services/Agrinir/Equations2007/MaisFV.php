...
{
    /**
     * Modifier les valeurs alimentaires d'un fourrage vert de maïs en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // dE%=0,997dMO-2,35
        $dE = ((0.997 * $dMO) - 2.35);
        // MS<3O EBo1=4487+2,019*MATo
        $EBo1 = (4487 + (2.019 * $MATo));
        // MS>30 EBo2=4487+2,019*MATo
        $EBo2 = ($EBo1);
        // DT_N=72
        $DT_N = 72;
        // dr%=70
        ...
        // MOD=MO*dMO/100
        $MOD = ($MOgKgMB * $dMO / 100);
        // MS=25 MOF=MOD-MG-(MAT*(1-DT/100))
        $MOF25 = ($MOD - $MG - $MATgKgMB * (1 - $DT_N / 100));
        // MS=30 MOF=MOD-MG-(MAT*(1-DT/100))
        $MOF30 = ($MOD - $MG - $MATgKgMB * (1 - $DT_N / 100));
        // MS=35 MOF=MOD-MG-(MAT*(1-DT/100))
        $MOF35 = ($MOD - $MG - $MATgKgMB * (1 - $DT_N / 100));
        // MS=40 MOF=MOD-MG-(MAT*(1-DT/100))
        $MOF40 = ($MOD - $MG - $MATgKgMB * (1 - $DT_N / 100));
        $PDIME = 0.0;
