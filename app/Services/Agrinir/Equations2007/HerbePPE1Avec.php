...
{
    /**
     * Modifier les valeurs alimentaires d'un ensilage d'herbe Prairie Permanente première coupe avec conservateur en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        $EBo2 = ($EBo1);
        // DT_N=0,96*(73,7+0,088MAT-0,00011MAT*MAT-0,25MS+2,5)
        $DT_N = ((73.7 + (0.088 * $MATgKgMS) - (0.00011 * $MATgKgMS * $MATgKgMS) - (0.25 * $MS100) + 2.5) * 0.96);
        ...
        // MOD=MO*dMO/100
        $MOD = ($MOgKgMB * $dMO / 100);
        // MS=25 MOF=MOD-MG-(MAT*1.11*(1-DT/100))-(85/1000*MS)
        $MOF25 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 85 / 1000 * $MS);
        // MS=30 MOF=MOD-MG-(MAT*1.11*(1-DT/100))-(85/1000*MS)
        $MOF30 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 85 / 1000 * $MS);
        // MS=35 MOF=MOD-MG-(MAT*1.11*(1-DT/100))-(85/1000*MS)
        $MOF35 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 85 / 1000 * $MS);
        // MS=40 MOF=MOD-MG-(MAT*1.11*(1-DT/100))-(85/1000*MS)
        $MOF40 = ($MOD - $MG - $MATgKgMB * 1.11 * (1 - $DT_N / 100) - 85 / 1000 * $MS);
