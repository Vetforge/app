...
{
    /**
     * Modifier les valeurs alimentaires d'un ensilage d'herbe Prairie Permanente deuxième coupe sans conservateur en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        $EBo2 = ($EBo1);
        // DT_N=73,7+0,088MAT-0,00011MAT*MAT-0,25MS
