...
{
    /**
     * Modifier les valeurs alimentaires d'une enrubanné de luzerne en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // MS<50 dMO%=134,2-0,211*ADF(g/kgMS)
        if ($MS100 < 50) {
            $dMO = (134.2 - (0.211 * $adfgKgMS));
        }
        // MS>50 dMO%=98,5-0,114*ADF
        if ($MS100 >= 50) {
            $dMO = (98.5 - (0.114 * $adfgKgMS));
        }
        ...
        $EBo2 = ($EBo1);
        // MS<50 DT%=73,7+0,088MAT-0,00011MAT*MAT-0,25MS+4,2
        if ($MS100 < 50) {
            $DT_N = (73.7 + (0.088 * $MATgKgMS) - (0.00011 * $MATgKgMS * $MATgKgMS) - (0.25 * $MS100) + 4.2);
        }
        // MS>50 DT%=50,8+0,12*MAT-0,00018MAT*MAT+5
        if ($MS100 >= 50) {
