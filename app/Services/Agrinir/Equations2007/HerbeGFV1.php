...
{
    /**
     * Modifier les valeurs alimentaires d'un fourrage vert d'herbe Graminées première coupe en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // Ebo=4531+1,735*MATo-71
        $EBo2 = ($EBo1);
        // DT_N=51,2+0,14*MAT-0,00017MAT*MAT+8,8
        $DT_N = (51.2 + (0.14 * $MATgKgMS) - (0.00017 * $MATgKgMS * $MATgKgMS) + 8.8);
