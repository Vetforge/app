...
{
    /**
     * Modifier les valeurs alimentaires d'un fourrage vert d'herbe Prairie Permanente deuxième coupe en fonction d'une analyse Agrinir
     *
     *
    ...
    public static function modifierValeursAlimentaires(
        ...
        // EBo=4531+1,735*MATo+82
        $EBo2 = ($EBo1);
        // DT_N=51,2+0,14*MAT-0,00017MAT*MAT
        $DT_N = (51.2 + (0.14 * $MATgKgMS) - (0.00017 * $MATgKgMS * $MATgKgMS));
